...
class MillChicken(pygame.sprite.Sprite):
    def __init__(self, screen, index):
        ...
        self.path = 'sources/img/mill/chickenwindmil' + str(self.img_index_list[index]) + '.png'
            ...
            if move == 'move_r':
                ...
                if self.current_time == self.max_time:
                    ...
                    if self.animation_index <= 35:
                        self.path = 'sources/img/mill/chickenwindmil' + str(self.animation_index) + '.png'
                        self.image = pygame.transform.scale(pygame.image.load(self.path), (200,200))
                        self.img_mask = pygame.mask.from_surface(self.image)
        ...
        if not self.alive:
            ...
            if self.current_death_time == 2:
                ...
                if self.death_animation_index == 3:
                    ...
                    self.path = 'sources/img/mill/chickenwindmildead' + str(self.animation_index) + '_' + str(self.death_animation_index) + '.png'
                    self.image = pygame.transform.scale(pygame.image.load(self.path), (200, 200))
